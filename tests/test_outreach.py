...
class TestOutreachTools:
    ...
    def test_get_candidate_profile_returns_json(self):
        ...
        import json
        from agents.outreach import get_candidate_profile
    ...
    def test_draft_linkedin_message_contains_company(self):
        ...
        from agents.outreach import draft_linkedin_message
    ...
    def test_draft_cover_letter_contains_key_info(self):
        ...
        from agents.outreach import draft_cover_letter
...
class TestOutreachAgent:
    ...
    def test_run_outreach_caps_at_five(self, mock_runner):
        ...
        many_jobs = [
            {"company": f"Company{i}", "title": "EM", "url": f"http://co{i}.com",
             "match_score": 80, "matching_skills": [], "strengths": "", "description": ""}
            for i in range(8)
        ]
